...
parser = argparse.ArgumentParser(
    description=(
        "Unified 7DoF relative-pose retargeting for the G1 right arm. "
...
parser.add_argument(
    "--g1-4dof-path",
    default="res/pick_place/g1_right_arm_4dof.npz",
...
parser.add_argument(
    "--out-path",
    default="res/pick_place/g1_right_arm_7dof_relative.npz",
...
human_shoulder = world_to_torso_local(xyz[:, RIGHT_SHOULDER])
human_elbow = world_to_torso_local(xyz[:, RIGHT_ELBOW])
human_wrist = world_to_torso_local(xyz[:, RIGHT_WRIST])
...
SHOULDER_BODY = "right_shoulder_yaw_link"
ELBOW_BODY = "right_elbow_link"
WRIST_BODY = "right_wrist_roll_link"
