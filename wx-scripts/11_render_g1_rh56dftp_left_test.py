...
ACTIVE = {
    "thumb_yaw": ("left_thumb_proximal_yaw_joint", 1.308),
    "thumb_pitch": ("left_thumb_proximal_pitch_joint", 0.6),
    "index": ("left_index_proximal_joint", 1.47),
    "middle": ("left_middle_proximal_joint", 1.47),
    "ring": ("left_ring_proximal_joint", 1.47),
    "pinky": ("left_pinky_proximal_joint", 1.47),
}
...
def main():
    parser = argparse.ArgumentParser(
        description=(
            ...
            "RH56DFTP-2L Inspire left hand opening and closing."
        )
    )
    parser.add_argument(
        "--xml-path",
        default=(
            ...
            "g1_description/g1_29dof_rh56dftp_left.xml"
        ),
    )
    parser.add_argument(
        "--output-mp4",
        default=(
            ...
            "g1_rh56dftp_left_hand_test.mp4"
        ),
    )
    ...
    print(
        ...
        "the left Inspire hand opened/closed."
    )
